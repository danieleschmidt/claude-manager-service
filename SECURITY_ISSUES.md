...
**Task ID:** code_note_664_test_continuous_executor_integration
**Severity:** 6/10
**File:** tests/integration/test_continuous_executor_integration.py
**Line:** 398
**Issue:** Line 398: security_notes="Standard security", test_notes="Add tests"
...
**Task ID:** code_note_668_test_continuous_executor_integration
**Severity:** 6/10
**File:** tests/integration/test_continuous_executor_integration.py
**Line:** 477
**Issue:** Line 477: security_notes="Major security implications",
...
**Task ID:** code_note_770_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 38
**Issue:** Line 38: security_notes="Security note",
...
**Task ID:** code_note_776_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 95
**Issue:** Line 95: 'test_notes': 'Requires security tests',
...
**Task ID:** code_note_814_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 258
**Issue:** Line 258: def test_extract_security_notes(self, temp_workspace):
...
**Task ID:** code_note_815_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 259
**Issue:** Line 259: """Test extraction of security notes from content"""
...
**Task ID:** code_note_817_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 266
**Issue:** Line 266: security_notes = executor._extract_security_notes(security_content)
...
**Task ID:** code_note_818_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 267
**Issue:** Line 267: assert "Security-related change" in security_notes
...
**Task ID:** code_note_819_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 268
**Issue:** Line 268: assert "security review" in security_notes
...
**Task ID:** code_note_821_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 272
**Issue:** Line 272: normal_notes = executor._extract_security_notes(normal_content)
...
**Task ID:** code_note_822_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 273
**Issue:** Line 273: assert "Standard security practices" in normal_notes
...
**Task ID:** code_note_838_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 427
**Issue:** Line 427: security_notes="Security review required",
...
**Task ID:** code_note_831_test_continuous_backlog_executor
**Severity:** 6/10
**File:** tests/unit/test_continuous_backlog_executor.py
**Line:** 296
**Issue:** Line 296: assert "Security-related change" in item.security_notes
